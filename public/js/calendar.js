...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var calendar = new _fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__["Calendar"](calendarEl, {
    ...
    selectable: true,
    events: function events(fetchInfo, succesCallback, failureCallback) {
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get('/posts/jsonprofile').then(function (response) {
        var workout = response.data.workouts;
        var posts = response.data.posts;
        var number = response.data.workouts.length;
        var events = [];
        var i = 0;
...
module.exports = __webpack_require__(/*! /home/ec2-user/environment/blog/resources/js/calendar.js */"./resources/js/calendar.js");
